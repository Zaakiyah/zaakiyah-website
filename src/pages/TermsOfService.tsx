					...
					<div className="text-[#002828] space-y-8">
						...
						<div>
							...
							<p className="text-lg text-[#002828]/70 leading-relaxed mb-4">
								By accessing or using Zaakiyah ("the Platform", "we", "us", or
							...
							<p className="text-lg text-[#002828]/70 leading-relaxed">
								...
								Zaakiyah. We reserve the right to modify these Terms at any time,
						...
						<div>
							...
							<p className="text-lg text-[#002828]/70 leading-relaxed mt-4">
								Our services are designed to help Muslims fulfill their Zakaat
								obligations in accordance with Shariah principles.
							</p>
						</div>
						...
						<div>
							<h2 className="text-3xl font-bold text-[#002828] mb-4">
								5. Zakaat Calculations and Donations
							</h2>
							<h3 className="text-2xl font-semibold text-[#002828] mb-3">
								5.1 Calculation Accuracy
							</h3>
							<p className="text-lg text-[#002828]/70 leading-relaxed mb-4">
								While we strive to provide accurate Zakaat calculation tools, you
								acknowledge that:
							</p>
							<ul className="list-disc list-inside space-y-2 text-lg text-[#002828]/70 ml-4">
								<li>Calculations are provided for informational purposes</li>
								<li>
									You should consult with qualified Islamic scholars for complex
									situations
								</li>
								<li>
							...
							<ul className="list-disc list-inside space-y-2 text-lg text-[#002828]/70 ml-4">
								...
								<li>
									Donations are distributed to verified beneficiaries in
									accordance with Shariah principles
								</li>
								<li>
									We charge processing fees as disclosed at the time of donation
								</li>
						...
						<div>
							...
							<p className="text-lg text-[#002828]/70 leading-relaxed mb-4">
								...
								graphics, logos, software, and designs, are the property of Zaakiyah
						...
						<div>
							...
							<p className="text-lg text-[#002828]/70 leading-relaxed mb-4">
								...
								Platform will be available at all times, uninterrupted, or
								error-free. We may suspend or discontinue the Platform at any time.
							</p>
							...
							<p className="text-lg text-[#002828]/70 leading-relaxed">
								To the maximum extent permitted by law, Zaakiyah shall not be liable
						...
						<div>
							...
							<p className="text-lg text-[#002828]/70 leading-relaxed">
								You agree to indemnify, defend, and hold harmless Zaakiyah and its
								officers, directors, employees, and agents from any claims, damages,
								losses, liabilities, and expenses (including legal fees) arising out
								of or relating to your use of the Platform, violation of these
						...
						<div>
							...
							<p className="text-lg text-[#002828]/70 leading-relaxed">
								...
								the Platform after such changes constitutes acceptance of the
								modified Terms.
							</p>
						</div>
						...
						<div>
							...
							<div className="bg-[#E0F2F2]/30 rounded-lg p-6 border border-[#00939D]/20">
								...
								<p className="text-lg text-[#002828]/70">
									Email:{' '}
									<a
										href="mailto:legal@zaakiyah.com"
